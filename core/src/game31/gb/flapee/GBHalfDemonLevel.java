...
//                )
        ...
        stage1.pipeGapRange = new Range(0.3f, 0.2f);
        ...
        stage1.tDemonIdleChatterDelay = new Range(Float.MAX_VALUE, 0);      // Dont need to speak in the beginning
        stage1.demonIdleChatter = null;

        stage1.demonPlayerHighscoreChatter = new SetRandomizedSelector<>(
                new DemonVoice("content/vo/demon/highscore_amazing.ogg", true, false),
                new DemonVoice("content/vo/demon/highscore_cracking.ogg", true, false),
                new DemonVoice("content/vo/demon/highscore_fullmonty.ogg", true, false),
                new DemonVoice("content/vo/demon/highscore_gutted.ogg", true, false),
                new DemonVoice("content/vo/demon/highscore_winner.ogg", true, false)
        );

        stage1.demonPlayerHitChatter = new SetRandomizedSelector<>(
                new DemonVoice("content/vo/demon/session2_pipe_1.ogg", true, false),
                new DemonVoice("content/vo/demon/session2_pipe_2.ogg", true, false),
                new DemonVoice("content/vo/demon/session2_pipe_3.ogg", true, false)
        );
        ...
        stage2.demonIdleChatter = new SetRandomizedSelector<>(
                new DemonVoice("content/vo/demon/session2_stage2_1.ogg", false, false),
                new DemonVoice("content/vo/demon/session2_stage2_2.ogg", false, false),
                new DemonVoice("content/vo/demon/session2_stage2_3.ogg", false, false)
        );

        stage2.demonPlayerHighscoreChatter = new SetRandomizedSelector<>(
                new DemonVoice("content/vo/demon/highscore_amazing.ogg", true, false),
                new DemonVoice("content/vo/demon/highscore_cracking.ogg", true, false),
                new DemonVoice("content/vo/demon/highscore_fullmonty.ogg", true, false),
                new DemonVoice("content/vo/demon/highscore_gutted.ogg", true, false),
        ...
        stage2.demonPlayerHitChatter = new SetRandomizedSelector<>(
                new DemonVoice("content/vo/demon/session2_pipe_1.ogg", true, false),
                new DemonVoice("content/vo/demon/session2_pipe_2.ogg", true, false),
                new DemonVoice("content/vo/demon/session2_pipe_3.ogg", true, false)
        );
        ...
        Stage stage3 = new Stage();     // This is a tough stage
        stage3.pipes = pipes;
        stage3.pipeBoundingXAdjust = 0.06f;
        stage3.pipeIntervalDistance = new Range(0.4f, 0f);
        stage3.pipeGapRange = new Range(0.3f, 0.1f);
        stage3.pipeDirectionAmount = new Range(3, 3);
        stage3.pipeYOffsetRange = new Range(0f, 0.2f);
        ...
        stage3.demonIdleChatter = new SetRandomizedSelector<>(
                // Just a little bit more
                new DemonVoice("content/vo/demon/session1_stage3_1.ogg", false, false),
                new DemonVoice("content/vo/demon/session1_stage3_2.ogg", false, false),
                new DemonVoice("content/vo/demon/session1_stage3_3.ogg", false, false)
        );

        stage3.demonPlayerHighscoreChatter = new SetRandomizedSelector<>(
                new DemonVoice("content/vo/demon/highscore_amazing.ogg", true, false),
                new DemonVoice("content/vo/demon/highscore_cracking.ogg", true, false),
                new DemonVoice("content/vo/demon/highscore_fullmonty.ogg", true, false),
                new DemonVoice("content/vo/demon/highscore_gutted.ogg", true, false),
        ...
        stage3.demonPlayerHitChatter = new SetRandomizedSelector<>(
                new DemonVoice("content/vo/demon/session2_pipe_1.ogg", true, false),
                new DemonVoice("content/vo/demon/session2_pipe_2.ogg", true, false),
                new DemonVoice("content/vo/demon/session2_pipe_3.ogg", true, false)
        );
        ...
        Stage stagePaywall = new Stage();     // This is literally a paywall
        stagePaywall.pipes = pipes;
        stagePaywall.pipeBoundingXAdjust = 0.06f;
        stagePaywall.pipeIntervalDistance = new Range(level.pipeSize, 0f);
        stagePaywall.pipeGapRange = new Range(0.2f, 0.0f);
        stagePaywall.pipeDirectionAmount = new Range(3, 3);
        stagePaywall.pipeYOffsetRange = new Range(0f, 0.2f);
        stagePaywall.pipeMinYOffsetRange = new Range(0.0f, 0.1f, true);
        stagePaywall.pipeMinY = 0.08f;
        stagePaywall.pipeMaxY = -level.groundY + 0.72f;
        stagePaywall.stageLength = new Range(3, 0);
        stagePaywall.stageStartX = 0.5f;

        stagePaywall.tDemonIdleChatterDelay = new Range(1.5f, 0);
        stagePaywall.demonIdleChatter = new SetRandomizedSelector<>(
                new DemonVoice("content/vo/demon/session2_stage3_1.ogg", false, false),
                new DemonVoice("content/vo/demon/session2_stage3_2.ogg", false, false),
                new DemonVoice("content/vo/demon/session2_stage3_3.ogg", false, false)
        );

        stagePaywall.demonPlayerHighscoreChatter = new SetRandomizedSelector<>(
                new DemonVoice("content/vo/demon/highscore_amazing.ogg", true, false),
                new DemonVoice("content/vo/demon/highscore_cracking.ogg", true, false),
                new DemonVoice("content/vo/demon/highscore_fullmonty.ogg", true, false),
                new DemonVoice("content/vo/demon/highscore_gutted.ogg", true, false),
        ...
        stagePaywall.demonPlayerHitChatter = new SetRandomizedSelector<>(
                new DemonVoice("content/vo/demon/session2_pipe_1.ogg", true, false),
                new DemonVoice("content/vo/demon/session2_pipe_2.ogg", true, false),
                new DemonVoice("content/vo/demon/session2_pipe_3.ogg", true, false)
        );

        stagePaywall.powerupCosts = new int[] {
                50,
                60,
                100,
        };
        stagePaywall.reviveCosts = new int[] {
                40,
                60,
                80,
                100,
        ...
        level.leaderboard = new LeaderboardScore[] {
                new LeaderboardScore("Teddy", 47, 714.7f, true),
                new LeaderboardScore("Calvin", 36, 265.6f, false),
                new LeaderboardScore("Natasha H", 25, 138.3f, false),
                new LeaderboardScore("Scott", 17, 23.6f, false),
                new LeaderboardScore("Freddy T", 16, 17.3f, false),
                new LeaderboardScore("Samuel T", 12, 10.1f, false),
                new LeaderboardScore("Cheah", 11, 9.7f, false),
        };
