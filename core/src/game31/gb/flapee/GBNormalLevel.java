...
public class GBNormalLevel implements FlapeeBirdScreen.LevelSource {
    @Override
...
//                )
        ...
        stage1.pipeGapRange = new Range(0.5f, 0.1f);
        ...
        stage1.demonPlayerHighscoreChatter = null;
        ...
        Stage stage2 = new Stage();     // This is a normal stage
        stage2.pipes = pipes;
        ...
        stage2.demonIdleChatter = new SetRandomizedSelector<>(
                new DemonVoice("content/vo/demon/session1_stage2_1.ogg", false, false),
                new DemonVoice("content/vo/demon/session1_stage2_2.ogg", false, false),
                new DemonVoice("content/vo/demon/session1_stage2_3.ogg", false, false)
        );
        ...
        stage2.demonPlayerHitChatter = new SetRandomizedSelector<>(
                new DemonVoice("content/vo/demon/session1_pipe_1.ogg", true, false),
                new DemonVoice("content/vo/demon/session1_pipe_2.ogg", true, false),
                new DemonVoice("content/vo/demon/session1_pipe_3.ogg", true, false)
        );
        ...
        Stage stage3 = new Stage();     // This is a scare stage
        stage3.pipes = pipes;
        stage3.pipeBoundingXAdjust = 0.06f;
        stage3.pipeIntervalDistance = new Range(level.pipeSize, 0f);
        stage3.pipeGapRange = new Range(0.35f, 0.0f);
        stage3.pipeDirectionAmount = new Range(3, 3);
        stage3.pipeYOffsetRange = new Range(0f, 0.05f);
        stage3.pipeMinYOffsetRange = new Range(0.0f, 0.05f, true);
        ...
        level.leaderboard = new LeaderboardScore[] {
                new LeaderboardScore("Teddy", 34, 314.7f, true),
                new LeaderboardScore("Calvin", 29, 235.6f, false),
                new LeaderboardScore("Natasha H", 21, 131.3f, false),
                new LeaderboardScore("Scott", 13, 17.6f, false),
                new LeaderboardScore("Freddy T", 15, 13.3f, false),
                new LeaderboardScore("Samuel T", 10, 7.1f, false),
                new LeaderboardScore("Cheah", 9, 6.7f, false),
        };
