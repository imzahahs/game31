...
public class InstancedMesh extends Mesh {
	...
	protected static class InstancedMeshRenderInstruction extends AbstractMeshRenderInstruction<InstancedMesh> {
		// Cached instructions
	...
	public static final VertexAttributes instancedVertexAttributes = new VertexAttributes(
		...
		new VertexAttribute(512, 1, a_instance)
	);
	...
	public InstancedMesh(int maxVertices, int maxIndices, int maxInstances) {
	...
	@MassConstructor
	public InstancedMesh(InstancedMesh copy) {
		super(copy);
		
		this.maxInstances = copy.maxInstances;
		this.instancedVertices = copy.instancedVertices;		// not used
		this.instancedIndices = copy.instancedIndices;			// not used
	...
	@MassConstructor
	public InstancedMesh(int maxInstances, float[] vertices, short[] indices, Material material, MaterialAttribute[] attribs) {
